...
pub struct MrIrep {
    ...
    pub iseq: *const u8,
    pub _pool: *const std::ffi::c_void,
    pub syms: *const u32,
    pub reps: *const *const MrIrep,
    //pub reps: *const *const std::ffi::c_void,
    pub lv: *const u32,
    pub debug_info: *const std::ffi::c_void,
...
extern "C" {
    ...
    pub fn mrb_ext_parse_nstring_as_proc(
        mrb: *const MrState,
        code: *const u8,
        len: i32,
    ) -> *const MrProc;

    pub fn mrb_ext_irep_from_rproc(proc: *const MrProc) -> *const MrIrep;

    pub fn mrb_ext_str_from_pool(proc: *const MrIrep, n: usize) -> *const c_char;

    pub fn mrb_ext_subirep_from_rproc(proc: *const MrProc, n: usize) -> *const MrIrep;
}
